-- Migration: Add config_timestamp to cognitive_fabric_node
-- Version: 2026-02-23
-- Description:
...
-- ====================
-- Update: cognitive_fabric_node (Add config_timestamp)
-- ====================
...
CREATE INDEX IF NOT EXISTS "idx_cfn_config_timestamp" ON "cognitive_fabric_node" ("config_timestamp");

-- Update existing rows to set config_timestamp to updated_at (or created_at if updated_at is null)
UPDATE "cognitive_fabric_node"
